...
* webpack 2/3 version
*
* for react hot loading, see https://github.com/gaearon/react-hot-loader
*
*
* @author: min
*/
...
const basename = '/demo/infinite-scroll/';
...
module.exports = {
  ...
  devtool: ENV === config.DEV_ENV ? 'source-map' : false,
  ...
  module: {
    ...
    rules: [
      // webpack 2 doens't support preLoaders. use enforce: "pre"
      // es lint
      {
        test: /\.(js|jsx)$/,
